...
export default function AIChatbot() {
  ...
  if (!isOpen) {
    return (
      <button
        ...
        className="fixed bottom-6 left-6 w-14 h-14 bg-gradient-to-r from-blue-600 to-purple-600 rounded-full shadow-lg flex items-center justify-center text-white hover:scale-110 transition-transform z-50 group"
      >
  ...
  return (
    <div className={`fixed bottom-6 left-6 z-50 ${isMinimized ? 'w-72' : 'w-96'} transition-all duration-300`}>
