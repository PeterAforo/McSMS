...
export default function AIChatbot() {
  ...
  if (!isOpen) {
    return (
      <button
        ...
        className="fixed bottom-4 left-4 sm:bottom-6 sm:left-6 w-14 h-14 bg-gradient-to-r from-blue-600 to-purple-600 rounded-full shadow-lg flex items-center justify-center text-white hover:scale-110 transition-transform z-50 group"
      >
  ...
  return (
    <div className={`fixed bottom-4 left-4 sm:bottom-6 sm:left-6 z-50 ${isMinimized ? 'w-72' : 'w-[calc(100vw-2rem)] sm:w-96 max-w-96'} transition-all duration-300`}>
