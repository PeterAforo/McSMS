...
export default function Register() {
  ...
  const selectedImage = useMemo(() => {
    ...
    const pageImages = images.filter((img) => img.page_assignment === 'register');
  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className={`hidden lg:flex lg:w-[60%] relative overflow-hidden ${selectedImage ? '' : 'bg-gradient-to-br from-emerald-600 via-teal-600 to-cyan-700'}`}>
        {selectedImage ? (
          <>
